...
<template>
  <div
    ...
    :class="cn('flex h-full flex-col bg-sidebar text-sidebar-foreground', props.class)"
    v-bind="$attrs"
  >
    <slot />
  </div>
  ...
  >
    ...
    <div
      :class="cn(
        'duration-200 relative h-svh bg-transparent transition-[width] ease-linear w-[var(--sidebar-width)]',
